...
const objections = [
  ...
  { q: "Can I stack revenue beyond just spraying?", a: "Yes - that's the model. Application fees are the base layer. On top of that, you can distribute SOURCE and BLUEPRINT precision inputs ($2-9/acre margin) and offer EarthOptics soil scanning services. The same grower relationship generates three revenue streams annually." },
