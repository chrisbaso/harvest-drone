        ...
        <section className="sp__hero">
          <div className="sp__hero-copy">
            ...
            <p className="sp__hero-sub">
              SOURCE is a biological soil activator that helps microbes fix atmospheric nitrogen and solubilize bound phosphorus, giving growers a simpler way to cut synthetic input dependency without sacrificing performance.
            </p>
          ...
          <div className="sp__form-card" ref={formRef}>
            {submitted ? (
              <div className="sp__success">
                ...
                <p>
                  Jake will follow up to confirm acres, timing, and delivery details. Current inventory is moving now, so we will reach out quickly.
                </p>
              </div>
            ) : (
              <form className="sp__form-grid" onSubmit={handleSubmit}>
                ...
                {orderType === "volume_quote" && (
                  <div className="sp__order-note">
                    Orders over 1,000 acres are handled as a volume quote. Jake will follow up directly with acreage planning, fulfillment timing, and custom pricing.
                  </div>
                )}
