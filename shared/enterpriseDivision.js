...
export const rdoEnterpriseDemo = {
  organization: {
    ...
    division: {
      ...
      flagshipAircraftModel: "HYL-300 Atlas",
      flagshipPositioning:
  ...
  operators: [
    {
      ...
      state: "North Dakota",
      aircraftModels: ["HYL-300 Atlas", "HYL-150 Ares"],
      ...
      credentials: [
        ...
        credential(CREDENTIAL_TYPES.HYLIO_ONBOARDING, { aircraftModel: "HYL-300 Atlas", payloadType: "liquid" }),
    ...
    },
    {
      ...
      credentials: [
        ...
        credential(CREDENTIAL_TYPES.FAA_PART_107_RECENCY),
        credential(CREDENTIAL_TYPES.HYLIO_ONBOARDING, { aircraftModel: "HYL-150 Ares", payloadType: "liquid" }),
        credential(CREDENTIAL_TYPES.HARVEST_INTERNAL_QUALIFICATION),
        credential(CREDENTIAL_TYPES.PESTICIDE_APPLICATOR_LICENSE, { state: "Minnesota", category: "Ag aerial application" }),
      ],
    },
  ...
  supportTickets: [
    { id: "ticket-1042", title: "HYL-300 Atlas pump calibration variance", status: "open", priority: "High", owner: "Harvest support" },
