...
create table if not exists public.grower_leads (
  ...
  nitrogen_program_notes text,
  phosphorus_program_notes text,
  fit_score text,
  lead_priority text,
  priority_tags text[],
...
create index if not exists harvest_drone_leads_created_at_idx on public.harvest_drone_leads (created_at desc);
create index if not exists harvest_drone_leads_tier_idx on public.harvest_drone_leads (lead_tier);
create index if not exists harvest_drone_leads_status_idx on public.harvest_drone_leads (status);
create index if not exists harvest_drone_leads_state_idx on public.harvest_drone_leads (state);
create index if not exists harvest_drone_events_lead_id_idx on public.harvest_drone_events (lead_id, created_at desc);

alter table public.harvest_drone_leads enable row level security;
alter table public.harvest_drone_events enable row level security;
